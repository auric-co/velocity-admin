                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">Velocity Clients</h3>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="table-data-feature">
                                                                <a href="edit.php?id=<?php echo $key['id'];?>" class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                                                    <i class="zmdi zmdi-edit"></i>
                                                                </a>
                                                                <a href="#" id="delete.<?php echo $key['id'];?>" class="item" data-toggle="tooltip" data-placement="top" title="Delete">
