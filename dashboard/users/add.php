                ...
                <div class="table-data__tool">
                            ...
                            <div class="table-data__tool-right">
                                <a href="./more.php?id=<?php echo $_GET['company']; ?>" class="au-btn au-btn-icon au-btn--green au-btn--small">
                                    <i class="zmdi zmdi-arrow-left"></i> Back to Company
                                </a>
                            </div>
                        </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">Add Member Form</div>
                            <div class="card-body">
                                <?php
                                if ($err){
                                    echo $err;
                                } ?>
                                <form action="<?php echo $_SERVER['PHP_SELF'];?>?company=<?php echo $_POST['company'] ? $_POST['company'] : $_GET['company']; ?>" method="post" id="add">
